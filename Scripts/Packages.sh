...
"$GITHUB_WORKSPACE/Scripts/pin_gettext_full.sh" \
	"$GITHUB_WORKSPACE/patches/gettext-full" \
...
UPDATE_PACKAGE "viking" "VIKINGYFY/packages" "main" "" "sing-box luci-app-homeproxy luci-app-timewol luci-app-wolplus"
